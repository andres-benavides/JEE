 ...
 */
package co.ejemplo.servlet;

import co.ejemplo.session.PersonaFacade;
...
public class ejemplo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            miPersonaSession = (PersonaFacade) new InitialContext().lookup("module/PersonaFacade");
